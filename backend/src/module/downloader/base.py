...
class DownloaderClient(Protocol):
    ...
    async def get_torrent_path(self, _hash) -> str: ...
    ...
    async def rss_add_feed(self, url, item_path) -> None: ...

    async def rss_remove_item(self, item_path) -> None: ...
    ...
    async def remove_rule(self, rule_name) -> None: ...
