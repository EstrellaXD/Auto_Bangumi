...
class Episode(BaseModel):
    ...
    episode: int = Field(default=0, alias="episode", title="番剧集数")
    ...
    year: str = Field(default="", alias="year", title="番剧年份")
    resolution: str = Field(default="", alias="resolution", title="分辨率")
    source: str = Field(default="", alias="source", title="视频来源")
    audio_info: list[str] = Field(default_factory=list, alias="audio_info", title="音频信息")
    video_info: list[str] = Field(default_factory=list, alias="video_info", title="视频信息")
