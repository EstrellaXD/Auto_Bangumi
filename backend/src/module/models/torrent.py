...
class Torrent(SQLModel, table=True):
    ...
    download_uid: str | None = Field(default=None, alias="download_uid", index=True)
    bangumi_official_title: str = Field(default="", index=True, alias="bangumi_official_title")
    bangumi_season: int = Field(default=1, index=True, alias="bangumi_season")
    rss_link: str = Field(default="", alias="rss_link", index=True)
